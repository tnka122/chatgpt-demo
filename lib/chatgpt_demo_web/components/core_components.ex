defmodule ChatgptDemoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChatgptDemoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChatgptDemoWeb.Gettext, "errors", msg, opts)
    end
  end
